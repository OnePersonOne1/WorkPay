...
abstract class AppLocalizations {
  ...
  /// No description provided for @calExportTitle.
  ///
  /// In ko, this message translates to:
  /// **'구글 캘린더로 보내기'**
  String get calExportTitle;

  /// No description provided for @calExportToolbarLabel.
  ///
  /// In ko, this message translates to:
  /// **'캘린더 공유'**
  String get calExportToolbarLabel;
  ...
  /// No description provided for @settingsCalendarExportHint.
  ///
  /// In ko, this message translates to:
  /// **'로그인 없이 캘린더 파일(.ics)로 근무 일정을 옮겨요'**
  String get settingsCalendarExportHint;

  /// No description provided for @calExportMonthShiftCount.
  ///
  /// In ko, this message translates to:
  /// **'이 달의 근무 {count}건이 캘린더 일정으로 만들어져요.'**
  String calExportMonthShiftCount(int count);

  /// No description provided for @calExportNoShifts.
  ///
  /// In ko, this message translates to:
  /// **'이 달에는 근무가 없어요. 위에서 다른 달을 선택해 주세요.'**
  String get calExportNoShifts;

  /// No description provided for @calExportButton.
  ///
  /// In ko, this message translates to:
  /// **'캘린더 파일(.ics) 만들기'**
  String get calExportButton;

  /// No description provided for @calExportFirstTimeTitle.
  ///
  /// In ko, this message translates to:
  /// **'처음이신가요? 이렇게 동작해요'**
  String get calExportFirstTimeTitle;

  /// No description provided for @calExportFirstTimeBody.
  ///
  /// In ko, this message translates to:
  ...
  /// No description provided for @calExportHowToTitle.
  ///
  /// In ko, this message translates to:
  /// **'구글 캘린더에 넣는 방법'**
  String get calExportHowToTitle;
  ...
  /// No description provided for @calExportNotesTitle.
  ///
  /// In ko, this message translates to:
  /// **'알아두면 좋아요'**
  String get calExportNotesTitle;

  /// No description provided for @calExportNotesBody.
  ///
  /// In ko, this message translates to:
  ...
  /// No description provided for @calExportUnknownJob.
  ///
  /// In ko, this message translates to:
  /// **'근무'**
  String get calExportUnknownJob;

  /// No description provided for @calExportSaved.
  ///
  /// In ko, this message translates to:
  /// **'캘린더 파일이 만들어졌어요:\n{path}'**
  String calExportSaved(String path);

  /// No description provided for @calExportFailed.
  ///
  /// In ko, this message translates to:
  /// **'캘린더 내보내기 실패: {error}'**
